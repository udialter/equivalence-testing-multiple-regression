...
# preparing empty place-holder for later use in the function
...
```{r}
#sample <- c(50, 75, 100, 250, 500, 1000)
```
...
Note: Thesis proposal uses the standard normal for the AH but your code is using the t distribution version. If you want to check to see how the results change from the t to z distribution, you can replace pt with pnorm on line 92.
